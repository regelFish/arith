...
{
        float Y1 = (vals.a - vals.b - vals.c + vals.d) * 4.0;
        float Y2 = (vals.a - vals.b + vals.c - vals.d) * 4.0;
        float Y3 = (vals.a + vals.b - vals.c - vals.d) * 4.0;
        float Y4 = (vals.a + vals.b + vals.c + vals.d) * 4.0;
...
struct fullPack calc2by2(A2 vComp, A2Methods_T methods, int col, int row)
{
        ...
        float avgPb = (one.pb + two.pb + three.pb + four.pb) / 4;
        float avgPr = (one.pr + two.pr + three.pr + four.pr) / 4;
